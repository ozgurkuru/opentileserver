...
function style_osm_carto(){
	...
	apt-get -y install ttf-dejavu ttf-unifont 
...
apt-get -y install	libboost-all-dev subversion git-core tar unzip wget bzip2 \
					...
					libapache2-mod-php php-xml/xenial
...
apt-get install -y osm2pgsql python-mapnik libmapnik3.0/xenial mapnik-utils libmapnik-dev
